...
const kAlwaysDisplayDrawer = BreakpointValue(watch: false, tablet: true);
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    final alwaysDisplayDrawer = context.layout.breakpoint > LayoutPlatformBreakpoint.watch;
    return Scaffold(
      appBar: AppBar(
      ...
      body: Row(
        children: [
          if (context.layout.breakpoint > LayoutPlatformBreakpoint.phone) ...[
            NavigationSideBar(
      ...
      bottomNavigationBar: context.layout.breakpoint < LayoutPlatformBreakpoint.tablet
          ? NavigationBottomBar(
              selectedIndex: index,
...
class HomeBody extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final double spacing = BreakpointValue(watch: 0.0, phone: 10.0).resolve(context);
      ...
      child: Container(
        ...
        child: CustomScrollView(
          slivers: [
            ...
            SliverGutter(),
            SliverMargin(
              margin: context.layout.breakpoint == LayoutPlatformBreakpoint.desktop
                  ? EdgeInsets.zero
                  : null,
              sliver: SliverGrid(
